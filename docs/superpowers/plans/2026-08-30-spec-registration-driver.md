...
**Pre-ruling record, retained for the reasoning that produced the ruling above — OQ-1 is 🔏 RULED: Option A, the constant prompt.** This subsection and "The options" below frame the question as still open because that is the state they were written in; do not read them as live.
