...
9. **Acceptance mapping** — `acceptance.md:70` gains a row for the `:74` holdout-quarantine clause holding **end-to-end**; #172 bullet 4 no longer reads "depends on E1's variant" and now cites both tests passing unedited plus the measured `INSERT OR IGNORE` no-op on the second call.
