...
WHY IT RIDES THE 16:35 TIMER, BEHIND resolve_day (ops/README.md's units
table has the order). Reflections need resolutions, and resolve_day writes
those at 16:35 — seven hours after the 09:35 trading day.
...
reddens tomorrow's audit. It runs behind the arithmetic legs, so a missing
